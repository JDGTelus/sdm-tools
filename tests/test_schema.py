...
class TestIndexes:
    ...
    def test_developer_indexes_created(self, in_memory_db):
        ...
        cursor = in_memory_db.cursor()
        cursor.execute("SELECT name FROM sqlite_master WHERE type='index' AND tbl_name='developers'")
    ...
    def test_jira_events_indexes_created(self, in_memory_db):
        ...
        cursor = in_memory_db.cursor()
        cursor.execute("SELECT name FROM sqlite_master WHERE type='index' AND tbl_name='jira_events'")
        indexes = [row[0] for row in cursor.fetchall()]
    ...
    def test_git_events_indexes_created(self, in_memory_db):
        ...
        cursor = in_memory_db.cursor()
        cursor.execute("SELECT name FROM sqlite_master WHERE type='index' AND tbl_name='git_events'")
        indexes = [row[0] for row in cursor.fetchall()]
    ...
    def test_daily_activity_summary_indexes_created(self, in_memory_db):
        ...
        cursor = in_memory_db.cursor()
        cursor.execute("SELECT name FROM sqlite_master WHERE type='index' AND tbl_name='daily_activity_summary'")
        indexes = [row[0] for row in cursor.fetchall()]
