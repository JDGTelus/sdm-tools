...
class TestNormalizeEmail:
    ...
    def test_aws_sso_prefix_removal(self):
        ...
        assert normalize_email('AWSReservedSSO_TELUS-IoT-Developer_xxx/user@telus.com') == 'user@telus.com'
        
        # Different SSO variations
        assert normalize_email('AWSReservedSSO_SomeRole/john.doe@example.com') == 'john.doe@example.com'
        assert normalize_email('AWSReservedSSO_Admin_12345/admin@company.com') == 'admin@company.com'
...
class TestExtractDeveloperFromJiraJson:
    ...
    def test_malformed_json(self):
        ...
        # Unclosed braces
        email, name, account_id = extract_developer_from_jira_json("{'emailAddress': 'test@example.com'")
