...
def create_normalized_schema(conn):
    ...
    """)
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_aliases_email ON developer_email_aliases(alias_email)")
    ...
    """)
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_sprints_dates ON sprints(start_date_local, end_date_local)")
    ...
    """)
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_issue_sprints_sprint ON issue_sprints(sprint_id)")
    ...
    """)
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_jira_events_dev_date ON jira_events(developer_id, event_date)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_jira_events_sprint ON jira_events(sprint_id, event_date)")
    ...
    """)
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_git_events_dev_date ON git_events(developer_id, commit_date)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_git_events_sprint ON git_events(sprint_id, commit_date)")
    ...
    """)
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_summary_date ON daily_activity_summary(activity_date)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_summary_sprint ON daily_activity_summary(sprint_id)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_summary_dev_date ON daily_activity_summary(developer_id, activity_date)")
