...
class TeamMemberExtractor:
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        console.print(
                            f"[yellow]Warning: Could not parse assignee data: {assignee_str[:100]}...[/yellow]")
                        continue
                ...
                console.print(
                    f"[yellow]Warning: Could not parse assignee data: {e}[/yellow]")
                continue
    ...
    def create_team_member_table(self):
        ...
        self.conn.commit()
        console.print(
            f"[green]✓ Created team_members table with {len(team_members)} members[/green]")
...
def get_team_filter_conditions() -> Tuple[str, str]:
    ...
    try:
        ...
        filter_condition = " OR ".join(
            all_conditions) if all_conditions else "1=0"
